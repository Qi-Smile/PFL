...
if __name__ == '__main__':
    ...
    parser.add_argument('--alg', type=str, default='fedavg',
                        help='Algorithm to choose: [base | fedavg | fedbn | fedprox | fedap | metafed | fedmoe ]')
    ...
    parser.add_argument('--private_ratio', type=float,
                        default=0.5, help='hyperparameter for fedmoe')
    parser.add_argument('--shared_epoch', type=float,
                        default=1, help='shared model epoch for fedmoe')
    parser.add_argument('--private_epoch', type=float,
                        default=1, help='private model epoch for fedmoe')
    parser.add_argument('--update_epoch', type=float,
                        default=5, help='update epoch of shared model for fedmoe')
    ...
    for a_iter in range(start_iter, args.iters):
        ...
        if args.alg == 'metafed':
            ...
            if args.alg == 'fedmoe':
                args.wk_iters=1 # fedmoe不需要指定这个参数
